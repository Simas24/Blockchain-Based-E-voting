...
class Block:
    def __init__(self, index, previous_hash, encrypted_vote, vote_time=None):
        self.index = index
    ...
    def calculate_hash(self):
        string_to_hash = (str(self.index) + self.vote_time + str(self.encrypted_vote) + self.previous_hash)
